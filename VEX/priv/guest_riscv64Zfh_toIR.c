...
#define RV64_SOPC_FSQRT 0b0101110

   if ((GET_FUNCT7() == RV64_SOPC_FSQRT && GET_RS2() == 0)
...
#define RV64_SOPC_FMIN_MAX 0b0010110

   if ((GET_FUNCT3() == 0 || GET_FUNCT3() == 1)
       && GET_FUNCT7() == RV64_SOPC_FMIN_MAX && GET_OPCODE() == OPC_OP_FP) {
      UInt  rd      = GET_RD();
      UInt  rs1     = GET_RS1();
      UInt  rs2     = GET_RS2();
      UInt  opc     = GET_FUNCT3();
...
#define RV64_SOPC_FCLASS 0b1110010

   if ((GET_FUNCT3() == 0b001 && GET_RS2() == 0)
       && GET_FUNCT7() == RV64_SOPC_FCLASS && GET_OPCODE() == OPC_OP_FP) {
      UInt  rd      = GET_RD();
      UInt  rs1     = GET_RS1();
